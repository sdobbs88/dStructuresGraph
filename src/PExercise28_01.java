...
* Description: Draws a map of US cities. Added Savannah to this map 
* as an exercise. 
* Due: 11/16/2016
...
public class PExercise28_01 extends Application {
    ...
    public void start(Stage primaryStage) {
        City[] vertices = {new City("Seattle", 75, 50),
            ...
            new City("Houston", 450, 360), new City("Savannah", 625, 330)};
        ...
        }; //12 represents Savannah and 7, 8, and 9 represent the other 3
            //cities that the lines are drawn to. 
